...
# v_label = r'$u_{\rm D}$'
x_label = r'$x (t)$'
fig_title = r'$T$ = ' + f'{T}' + r'$\Delta t$ (' + r'$f =$' + f'{f:.2f})' + r', ${\tau}^{\ast}$ = ' + f'{tau_uv_D}' + r'$\Delta t$ (fixed)'
...
legend_font = 11
title_font = 16
# out_file = 'rough_sim_JF.pdf'
out_file = 'rough_sim_PM.pdf'
...
legend = plt.legend(handles = [p1, p1b, p2, p3], loc='lower left', fontsize=legend_font).get_frame().set_alpha(0.95)
